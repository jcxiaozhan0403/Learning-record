...
<body>
<form class="form-signin needs-validation" method="post" action="<c:url value="/manager/checkLogin" />" style="background-color: rgba(169,169,169,0.4);border-radius: 15px;" novalidate>
