...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" href="<c:url value="/management/home" />">
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/management/home" />">首页 <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    <a class="dropdown-item" href="<c:url value="/management/user/list" />">用户列表</a>
                    <a class="dropdown-item" href="<c:url value="/management/user/new" />">新增用户</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/management/image/list" />">图片管理</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<c:url value="/management/log" />">操作日志</a>
            </li>
            ...
            <li class="nav-item" id="logout">
                <a class="nav-link" href="<c:url value="/management/logout" />">注销</a>
            </li>
        </ul>
    </div>
</nav>
