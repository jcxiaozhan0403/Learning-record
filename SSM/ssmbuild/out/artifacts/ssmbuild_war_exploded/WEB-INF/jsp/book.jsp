            ...
            <table class="table table-hover table-striped" style='vertical-align: middle;text-align: center;'>
                ...
                <c:forEach var="book" items="${requestScope.get('list')}">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="${pageContext.request.contextPath}/book/edit?id=${book.getBookID()}" style="margin-right: 10px">修改</a>
                            <a class="btn btn-danger" href="${pageContext.request.contextPath}/book/delete/${book.getBookID()}">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
