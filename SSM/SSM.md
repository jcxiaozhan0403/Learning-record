...
<mvc:interceptors>
   ...
   <!-- 可以配置多个拦截器 -->
    <mvc:interceptor>
       <mvc:mapping path="/**"/>
       <bean class="com.kuang.interceptor.MyInterceptor2"/>
   </mvc:interceptor>
</mvc:interceptors>
```
...
2. 在配置文件中注册Spring自带的文件上传类CommonsMultipartResolver，id必须为multipartResolver，否则会报错
